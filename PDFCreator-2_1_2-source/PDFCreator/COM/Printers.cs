...
namespace pdfforge.PDFCreator.COM
{
    ...
    {
        private readonly Shared.Helper.PrinterHelper _printerHelper;
        ...
        public int Count
        {
            get
            {
                return _printerHelper.GetPDFCreatorPrinters().Count;
            }
        }
        ...
        {
            var printerList = (IList<string>)_printerHelper.GetPDFCreatorPrinters();
