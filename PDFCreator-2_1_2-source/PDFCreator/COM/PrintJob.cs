...
namespace pdfforge.PDFCreator.COM
{
    ...
    [ComVisible(true)]
    [GuidAttribute("489689FE-E8AF-41FF-8D5A-8212DF2F013C")]
    ...
    [ProgId("PDFCreatorBeta.PrintJob")]
    public class PrintJob : IPrintJob
    {
        ...
        private readonly List<string> _unaccessibleItems = new List<string> { "autosave", "properties", "skipprintdialog", "savedialog" };
        ...
        /// <summary>
        /// Returns a string which describes the current conversion step. This is "Pending" if it has not been started and "Finished", when it is completed successfully. Other values occur in between.
        /// </summary>
        public string ConversionState
        {
            get
            {
                return _workflow == null ? "Pending" : _workflow.WorkflowStep.ToString();
            }
        }
        ...
        public PrintJob(IJob job, IJobInfoQueue comJobInfoQueue)
        {
        ...
        /// <summary>
        /// Set a conversion profile property using two strings: One for the name (i.e. PdfSettings.Security.Enable) and one for the value
        /// </summary>
        ...
        private bool HasAccess(string propertyName)
        {
            ...
            return !_unaccessibleItems.Any(item => propertyName.ToLower().StartsWith(item));
        }
