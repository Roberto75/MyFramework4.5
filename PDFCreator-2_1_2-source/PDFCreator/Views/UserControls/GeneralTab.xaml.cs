...
namespace pdfforge.PDFCreator.Views.UserControls
{
    public partial class GeneralTab : UserControl
    {
        ...
        {
            get { return OsHelper.UserIsAdministrator() ? Visibility.Collapsed : Visibility.Visible; }
        }
        ...
        private void UpdateCheckButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                UpdateAssistant.Instance.Initialize(ViewModel.ApplicationSettings, ViewModel.ApplicationProperties);
            ...
            {
                var message = TranslationHelper.Instance.GetTranslation("UpdateManager",
                    "UpdateCheckIsRunning", "Update-Check is already running.");
                var caption = TranslationHelper.Instance.GetTranslation("UpdateManager",
