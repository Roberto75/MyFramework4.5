...
namespace pdfforge.PDFCreator.Views.UserControls
{
    public partial class DebugTab : UserControl
    {
        ...
        private void ShowLogButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                var caption = TranslationHelper.Instance.GetTranslation("ApplicationSettingsWindow", "NoLogFile",
                    "No log file");
                var message = TranslationHelper.Instance.GetTranslation("ApplicationSettingsWindow",
        ...
        private bool QuerySaveModifiedSettings()
        {
            ...
            var caption = TranslationHelper.Instance.GetTranslation("ApplicationSettingsWindow", "AppSettings",
        ...
        private void SaveIniButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            saveFileDialog.Filter = TranslationHelper.Instance.GetTranslation("ApplicationSettingsWindow",
        ...
        private void LoadIniButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            openFileDialog.Filter = TranslationHelper.Instance.GetTranslation("ApplicationSettingsWindow",
                "IniFileFilter", "INI files (*.ini)|*.ini");
            ...
            var caption = TranslationHelper.Instance.GetTranslation("ApplicationSettingsWindow", "OverwriteAllSettings",
            ...
            {
                message = TranslationHelper.Instance.GetTranslation("ApplicationSettingsWindow",
                    "InvalidSettingsWarning",
                    "The file does not appear to contain valid PDFCreator settings.");
                caption = TranslationHelper.Instance.GetTranslation("ApplicationSettingsWindow", "InvalidSettings",
                    "Invalid settings");
