...
namespace pdfforge.PDFCreator.Views.ActionControls
{
    public partial class EmailClientActionControl : ActionControl
    {
        ...
        public EmailClientActionControl()
        {
            ...
            DisplayName = TranslationHelper.Instance.GetTranslation("EmailClientActionSettings", "DisplayName", "Open e-mail client");
            Description = TranslationHelper.Instance.GetTranslation("EmailClientActionSettings", "Description",
        ...
        private void EmailClientTestButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (emailClient == null)
            {
                string caption = TranslationHelper.Instance.GetTranslation("EmailClientActionSettings", "CheckMailClient", "Check e-mail client");
                string message = TranslationHelper.Instance.GetTranslation("EmailClientActionSettings", "NoMapiClientFound",
            ...
            {
                _logger.WarnException("Exception while creating mail", ex);
            }
        }
