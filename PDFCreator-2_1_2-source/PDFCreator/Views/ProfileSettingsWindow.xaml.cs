...
namespace pdfforge.PDFCreator.Views
{
    public partial class ProfileSettingsWindow : Window
    {
        ...
        public ProfileSettingsWindow(PdfCreatorSettings settings)
        {
            InitializeComponent();
        ...
        private ProfileSettingsViewModel CreateViewModel(PdfCreatorSettings settings)
        {
            ...
            viewModel.QueryDiscardChangesInOtherProfiles = QueryDiscardChangesInOtherProfiles;
            ...
            viewModel.InvalidProfileMessage = TranslationHelper.GetTranslation("ProfileSettingsWindow",
        ...
        private string QueryProfileName(string profileName)
        {
            ...
            f.QuestionText = TranslationHelper.GetTranslation("ProfileSettingsWindow", "EnterProfileName",
                "Please enter profile name:");

            if (profileName != null)
                f.InputText = profileName;
            else
                f.InputText = TranslationHelper.GetTranslation("ProfileSettingsWindow", "NewProfile", "New Profile");

            f.Title = TranslationHelper.GetTranslation("ProfileSettingsWindow", "ProfileName", "Profile name");
        ...
        {
            var message = TranslationHelper.GetFormattedTranslation("ProfileSettingsWindow", "ReallyDeleteProfile",
                "Do you really want to the delete '{0}'?", ViewModel.CurrentProfile.Name);
            var caption = TranslationHelper.GetTranslation("ProfileSettingsWindow", "DeleteProfile",
                "Delete profile");
        ...
        {
            var message = TranslationHelper.GetFormattedTranslation("ProfileSettingsWindow",
            ...
            var caption = TranslationHelper.GetTranslation("ProfileSettingsWindow", "ProfileHasPrinterTitle",
                "Printer assignment");
            if (MessageWindow.ShowTopMost(message, caption, MessageWindowButtons.YesNo, MessageWindowIcon.Question) !=
                MessageWindowResponse.Yes)
            {
        ...
        {
            var caption = TranslationHelper.GetTranslation("ProfileSettingsWindow", "UnsavedChanges", "Unsaved changes");
            var message = TranslationHelper.GetTranslation("ProfileSettingsWindow", "ReallyWantToCancel",
        ...
        private static bool QueryDiscardChangesInOtherProfiles()
        {
            var message = TranslationHelper.GetTranslation("ProfileSettingsWindow", "YouMadeChangesInOtherProfiles",
                "You have made changes in at least one other profile.\r\nIf you proceed they will get lost.");
            var caption = TranslationHelper.GetTranslation("ProfileSettingsWindow", "UnsavedChangesInOtherProfiles",
                "Unsaved changes in other profiles");
            if (MessageWindow.ShowTopMost(message, caption, MessageWindowButtons.OKCancel, MessageWindowIcon.Warning) ==
                MessageWindowResponse.OK)
                return true;
