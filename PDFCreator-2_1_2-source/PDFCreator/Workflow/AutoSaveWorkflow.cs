...
namespace pdfforge.PDFCreator.Workflow
{
    ...
    /// </summary>
    public class AutoSaveWorkflow : ConversionWorkflow
    {
        ...
        protected override void QueryTargetFile()
        {
            ...
            string outputFolder = FileUtil.MakeValidFolderName(tr.ReplaceTokens(Job.Profile.AutoSave.TargetDirectory));
