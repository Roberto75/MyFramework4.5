...
namespace pdfforge.PDFCreator.Workflow
{
    ...
    /// </summary>
    public abstract class ConversionWorkflow
    {
        /// <summary>
        ...
        private void DoWorkflowWork()
        {
            ...
            Logger.Debug("PDFCreator Version: " + VersionHelper.GetCurrentApplicationVersion_WithBuildnumber());
            Logger.Debug("OSVersion: " + OsHelper.GetWindowsVersion());
