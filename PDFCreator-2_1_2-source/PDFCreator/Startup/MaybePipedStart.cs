...
{
    public abstract class MaybePipedStart : IAppStart
    {
        ...
        private bool TryStartApplication()
        {
            ...
            {
                _logger.Error("There was an error while starting the application: {0}", ex);
                return false;
            }
        }
        ...
        {
            if (e.Message.StartsWith("ReloadSettings|"))
            {
        ...
        {
            UpdateAssistant.Instance.Initialize(SettingsHelper.Settings);
