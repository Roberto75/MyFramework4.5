...
{
    public class ManagePrintJobsViewModel : ViewModelBase
    {
        ...
        public DelegateCommand MergeJobsCommand { get; private set; }
        public DelegateCommand MergeAllJobsCommand { get; private set; }
