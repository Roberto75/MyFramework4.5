...
namespace pdfforge.PDFCreator.Utilities.Communication
{
    /// <summary>
    ...
    public class PipeServer
    {
        ...
        public static bool ServerInstanceRunning(string name)
        {
            try
            {
                string mutexName = ComposeMutexName(name);
        ...
        {
            string sessionPipeName = pipeName + "-" + System.Diagnostics.Process.GetCurrentProcess().SessionId;
        ...
        public void Stop()
        {
            ...
            PipeClient client = PipeClient.CreatePipeClient(_pipeName);
            ...
            if (OnServerClosed != null)
                OnServerClosed(this, new EventArgs());
        }
        ...
        private void EventThread(Object command)
        {
            ...
            if ((!String.IsNullOrEmpty(commandString)) && (OnNewMessage != null))
            {
                OnNewMessage(this, new MessageEventArgs(commandString));
            }
        } // EventThread()
