...
namespace pdfforge.PDFCreator.Utilities.Communication
{
    ...
    /// If a process is releasing the Mutex or exits without releasing it, the other instances will fight for the mutex and acquire it.
    ...
    public class GlobalMutex
    {
        ...
        /// <summary>
        /// Tries to acquire the Mutex. This is done in a seperate Thread, because this may take a long time till it is released from another process
        /// </summary>
        public void Acquire()
        {
