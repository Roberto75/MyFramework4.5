...
{
    /// <summary>
    /// SynchronizedThread wraps a Thread object and adds some functionality to manage multiple threads. It allows to subscribe to an event that is launched when the Thread work has finished.
    /// </summary>
    public sealed class SynchronizedThread : ISynchronizedThread
    {
        ...
        private void RunThread()
        {
            try
            {
                ...
                {
                    //_logger.Error("There was an error while executing the thread function:" + ex);
                    throw;
                }
            }
            finally
