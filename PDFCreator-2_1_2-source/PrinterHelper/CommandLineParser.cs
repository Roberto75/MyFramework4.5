...
namespace pdfforge.PrinterHelper
{
    ...
    public static class CommandLineParser
    {
        ...
        public static IDictionary<string, IList<string>> ParseCommandLine(string[] args)
        {
        ...
        /// <returns>A Dictionary where the arguments are the keys and parameters to the arguments are in a List. Keep in mind that the List may be null!</returns>
        public static IDictionary<string, IList<string>> ParseCommandLine(string[] args, bool ignoreArgumentCase)
        {
        ...
        /// </remarks>
        public static IDictionary<string, IList<string>> ParseCommandLine(string[] args, bool ignoreArgumentCase, bool allowMultipleParameters)
        {
