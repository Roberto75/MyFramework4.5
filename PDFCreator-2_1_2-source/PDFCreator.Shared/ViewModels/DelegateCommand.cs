...
{
    /// <summary>
    /// DelegateCommand implements the <see cref="System.Windows.Input.ICommand"/> interface and uses delegates for the actual work (checking CanExecute and doing Execute)
    /// </summary>
    public class DelegateCommand : ICommand, INotifyPropertyChanged
    {
        ...
        /// <param name="canExecute">Will be executed to check if the Command can be executed. If no delegate is provided, this will always return true</param>
