...
namespace pdfforge.PDFCreator.Shared.Views.ActionControls
{
    public partial class FtpActionControl : ActionControl
    {
        ...
        public FtpActionControl(TokenReplacer tokenReplacer)
        {
            ...
            DisplayName = TranslationHelper.Instance.GetTranslation("FtpActionSettings", "DisplayName", "Upload with FTP");
            Description = TranslationHelper.Instance.GetTranslation("FtpActionSettings", "Description", "The FTP action allows to upload the created documents to a server via FTP.");
