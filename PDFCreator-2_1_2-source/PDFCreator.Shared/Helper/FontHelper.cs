    ...
    internal static class FontHelper
    {
        ...
        private static Dictionary<string, string> BuildFontDictionary()
        {
            ...
            foreach (string fontKey in valueNames)
            {
                ...
                if ((registryFontFileName != null) && Path.GetExtension(registryFontFileName).Equals(".ttf", StringComparison.CurrentCultureIgnoreCase))
                {
                    var trueType = new TrueTypeFontInfo.TrueType();
