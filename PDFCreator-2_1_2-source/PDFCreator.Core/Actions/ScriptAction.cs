    ...
    public class ScriptAction : IAction, ICheckable
    {
        ...
        public ActionResult Check(ConversionProfile profile)
        {
            ...
            if (profile.Scripting.Enabled)
            {
                ...
                else if (!FileUtil.IsValidFilename(scriptFile))
                {
        ...
        public static string ComposeScriptPath(string path, TokenReplacer tokenReplacer)
        {
            ...
            composedPath = FileUtil.MakeValidFolderName(composedPath);

            return composedPath;
        }

        public static string ComposeScriptParameters(string parameterString, IList<string> outputFiles, TokenReplacer tokenReplacer)
        {
