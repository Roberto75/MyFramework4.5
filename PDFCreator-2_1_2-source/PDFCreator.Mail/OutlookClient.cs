...
namespace pdfforge.PDFCreator.Mail
{
    public class OutlookClient : IEmailClient
    {
        ...
        public virtual bool IsOutlookInstalled
        {
            get { return OutlookType != null; }
        }
        ...
        public bool ShowEmailClient(Email email)
        {
            ...
            {
                _logger.ErrorException("Error while starting Outlook", ex);
                return false;
            }
        }
        ...
        private void AddHtmlBody(dynamic mail, string body)
        {
            ...
            {
                string bodyTag = bodyMatch.Groups[0].Value;
