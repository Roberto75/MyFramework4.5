...
{
    static class XmpMetadataUpdater
    {
        //ActionId = 27;
        ...
        public static void UpdateXmpMetadata(PdfStamper stamper, ConversionProfile profile)
        {
            ...
            {
                throw new ProcessingException(ex.GetType() + " while addding updating xmp metadata:" + Environment.NewLine + ex.Message, 27999);
            }
        }
        ...
        private static string GetHexString(string s)
        {
            ...
            foreach (char t in s)
            {
                string ts = Convert.ToInt32(t).ToString("x");
        ...
        private static string GetXmpDate(string metadataDate)
        {
            ...
            string s = metadataDate.Substring(2, 4) + "-" + metadataDate.Substring(6, 2) + "-" + metadataDate.Substring(8, 2) + "T" +
