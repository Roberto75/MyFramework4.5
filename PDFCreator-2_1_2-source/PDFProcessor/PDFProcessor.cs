    ...
    public static class PDFProcessor
    {
        ...
        public static void ProcessPDF(string pdfFile, ConversionProfile profile, JobPasswords jobPasswords)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ProcessingException(ex.GetType() + " while processing file:" + pdfFile + Environment.NewLine + ex.Message, 26999);
            }
        }
        ...
        /// <returns>Decimal of PDFVersion as char</returns>
        ...
        public static string MoveFileToPreProcessFile(string pdfFile)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new ProcessingException(ex.GetType() + " while creating pdf preprocess file:" + Environment.NewLine + ex.Message, 26101);
            }
        ...
        private static void DoProcessPDF(string pdfFile, ConversionProfile profile, JobPasswords jobPasswords)
        {
            ...
            try
            {
                ...
                using (var stamper = StamperCreator.CreateStamperAccordingToEncryptionAndSignature(preProcessFile, pdfFile, profile))
                {
