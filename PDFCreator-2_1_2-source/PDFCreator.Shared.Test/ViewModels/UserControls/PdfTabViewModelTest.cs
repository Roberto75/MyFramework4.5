...
namespace PDFCreator.Shared.Test.ViewModels.UserControls
{
    ...
    public class PdfTabViewModelTest
    {
        ...
        [Test]
        public void SetLowEncryptionEnabled_RaisePropertyChanged()
        {
            var pdfTabViewModel = new PdfTabViewModel();
            pdfTabViewModel.CurrentProfile = new ConversionProfile();
        ...
        [Test]
        public void SetMediumEncryptionEnabled_RaisePropertyChanged()
        {
            var pdfTabViewModel = new PdfTabViewModel();
            pdfTabViewModel.CurrentProfile = new ConversionProfile(); 
        ...
        [Test]
        public void SetHighEncryptionEnabled_RaisePropertyChanged()
        {
            var pdfTabViewModel = new PdfTabViewModel();
            pdfTabViewModel.CurrentProfile = new ConversionProfile();
        ...
        [Test]
        public void LowMediumHighEncryptionEnabled_ExtendedPermissonsEnabled_EncryptionLevelToBooleanTest()
        {
            var pdfTabViewModel = new PdfTabViewModel();
            pdfTabViewModel.CurrentProfile = new ConversionProfile();
            ...
            //128BitAes Encryption
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.EncryptionLevel =
                EncryptionLevel.Aes128Bit;
        ...
        [Test]
        public void LowMediumHighEncryptionEnabled_ExtendedPermissonsEnabled_BooleanToEncryptionLevel_Test()
        {
            var pdfTabViewModel = new PdfTabViewModel();
            pdfTabViewModel.CurrentProfile = new ConversionProfile();
            ...
            Assert.IsFalse(pdfTabViewModel.ExtendedPermissonsEnabled, "Extended permissions enabled for low encryption");

            pdfTabViewModel.CurrentProfile.PdfSettings.Security.RestrictPrintingToLowQuality = true;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToFillForms = true;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowScreenReader = true;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToEditAssembly = true;
            Assert.IsFalse(pdfTabViewModel.RestrictLowQualityPrintingEnabled, "RestrictLowQualityPrintingEnabled is true for low encryption");
            Assert.IsTrue(pdfTabViewModel.AllowFillFormsEnabled, "AllowFillFormsEnabled is false for low encryption");
            Assert.IsTrue(pdfTabViewModel.AllowScreenReadersEnabled, "AllowScreenReadersEnabled is false for low encryption");
            Assert.IsTrue(pdfTabViewModel.AllowEditingAssemblyEnabled, "AllowEditingAssemblyEnabled is false for low encryption");
            ...
            Assert.IsTrue(pdfTabViewModel.ExtendedPermissonsEnabled, "Extended permissions disabled for 128Bit encryption");

            pdfTabViewModel.CurrentProfile.PdfSettings.Security.RestrictPrintingToLowQuality = true;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToFillForms = true;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowScreenReader = true;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToEditAssembly = true;
            Assert.IsTrue(pdfTabViewModel.RestrictLowQualityPrintingEnabled, "Enabled RestrictLowQualityPrintingEnabled is false for 128Bit encryption");
            Assert.IsTrue(pdfTabViewModel.AllowFillFormsEnabled, "Enabled AllowFillFormsEnabled is false for 128Bit encryption");
            Assert.IsTrue(pdfTabViewModel.AllowScreenReadersEnabled, "Enabled AllowScreenReadersEnabled is false for 128Bit encryption");
            Assert.IsTrue(pdfTabViewModel.AllowEditingAssemblyEnabled, "Enabled AllowEditingAssemblyEnabled is false for 128Bit encryption");

            pdfTabViewModel.CurrentProfile.PdfSettings.Security.RestrictPrintingToLowQuality = false;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToFillForms = false;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowScreenReader = false;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToEditAssembly = false;
            Assert.IsFalse(pdfTabViewModel.RestrictLowQualityPrintingEnabled, "Disabled RestrictLowQualityPrintingEnabled is true for 128Bit encryption");
            Assert.IsFalse(pdfTabViewModel.AllowFillFormsEnabled, "Disabled  AllowFillFormsEnabled is true for 128Bit encryption");
            Assert.IsFalse(pdfTabViewModel.AllowScreenReadersEnabled, "Disabled  AllowScreenReadersEnabled is true for 128Bit encryption");
            Assert.IsFalse(pdfTabViewModel.AllowEditingAssemblyEnabled, "Disabled AllowEditingAssemblyEnabled is true for 128Bit encryption");
            ...
            Assert.IsTrue(pdfTabViewModel.ExtendedPermissonsEnabled, "Extended permissions disabled for 128BitAes encryption");

            pdfTabViewModel.CurrentProfile.PdfSettings.Security.RestrictPrintingToLowQuality = true;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToFillForms = true;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowScreenReader = true;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToEditAssembly = true;
            Assert.IsTrue(pdfTabViewModel.RestrictLowQualityPrintingEnabled, "Enabled RestrictLowQualityPrintingEnabled is false for 128BitAes encryption");
            Assert.IsTrue(pdfTabViewModel.AllowFillFormsEnabled, "Enabled AllowFillFormsEnabled is false for 128BitAes encryption");
            Assert.IsTrue(pdfTabViewModel.AllowScreenReadersEnabled, "Enabled AllowScreenReadersEnabled is false for 128BitAes encryption");
            Assert.IsTrue(pdfTabViewModel.AllowEditingAssemblyEnabled, "Enabled AllowEditingAssemblyEnabled is false for 128BitAes encryption");

            pdfTabViewModel.CurrentProfile.PdfSettings.Security.RestrictPrintingToLowQuality = false;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToFillForms = false;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowScreenReader = false;
            pdfTabViewModel.CurrentProfile.PdfSettings.Security.AllowToEditAssembly = false;
            Assert.IsFalse(pdfTabViewModel.RestrictLowQualityPrintingEnabled, "Disabled RestrictLowQualityPrintingEnabled is true for 128BitAes encryption");
            Assert.IsFalse(pdfTabViewModel.AllowFillFormsEnabled, "Disabled  AllowFillFormsEnabled is true for 128BitAes encryption");
            Assert.IsFalse(pdfTabViewModel.AllowScreenReadersEnabled, "Disabled  AllowScreenReadersEnabled is true for 128BitAes encryption");
            Assert.IsFalse(pdfTabViewModel.AllowEditingAssemblyEnabled, "Disabled AllowEditingAssemblyEnabled is true for 128BitAes encryption");
        }
