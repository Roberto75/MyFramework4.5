...
namespace pdfforge.PDFProcessing.Test
{
    [TestFixture]
    ...
    class BackgroundPageTest
    {
        ...
        public void SetUp()
        {
            _th = new TestHelper("PDFProcessing background page test");
        ...
        public void NoRepetition()
        {
            ...
            string pageText = PdfTextExtractor.GetTextFromPage(reader, 1).Replace("\n", "").Replace(" ", "");
