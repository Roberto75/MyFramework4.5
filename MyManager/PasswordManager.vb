Public Class PasswordManager
    ...
    Private DEFAULT_MAX_PASSWORD_LENGTH As Integer = 50
    ...
    Public PASSWORD_CHARS_SPECIAL As String = "_.!?/"
    Public PASSWORD_CHARS_SPECIAL_DENY As String = "{}[]()-+*@;,|%$#<>'&"""
    ' apici e doppi apici
    ...
    Public Function GeneratePassword() As String
        GeneratePassword = GeneratePassword(DEFAULT_MIN_PASSWORD_LENGTH, _
    ...
    Public Function GeneratePassword(ByVal length As Integer) As String
        GeneratePassword = GeneratePassword(length, length)
    End Function
    ...
    Public Function getCodiceAlfaNumerico(ByVal lenght As Integer) As String
        PASSWORD_CHARS_SPECIAL_DENY = "{}[]()-+*@;,|%$#<>'&"".!?/"
        PASSWORD_CHARS_SPECIAL = "_"

        Return GeneratePassword(lenght)
    End Function
End Class
